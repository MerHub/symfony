...
public class ServiceChauffeur {
    ...
    public ArrayList<Chauffeur> parseChauffeur(String jsonText){
        ...
        return chauffeur;
                ...
                public String setChauffeur(String adresse,int cin,String permis,String nom,String prenom,String image,int id){
      String url = Statics.BASE_URL+"/chauffeur/serviceSetChauffeur/"+adresse+"/"+cin+"/"+permis+"/"+nom+"/"+prenom+"/"+image+"/"+id;
    ...
    public String setTaxi(int id,int categori,String numChassis){
      String url = Statics.BASE_URL+"/Taxi/service_setTaxi/"+numChassis+"/"+categori+"/"+id;
